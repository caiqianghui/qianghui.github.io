...
export default (props: Props) => {
  const {onChange, onSearch, title, onCancel, onAddModule, module, isNewAdd} = props;
    ...
    <NavBar
      ...
      right={
        <View>
          ...
          {module && (isNewAdd || module.isNew) && <AddOutline style={{marginLeft: '16px'}} fontSize={20} onClick={() => onAddModule()} color="#FFF"/>}
        </View>
      }>
